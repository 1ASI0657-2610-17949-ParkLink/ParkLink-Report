...
|---------------------|---------------------|--------------|
| **CO1:** Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | **Persona 1 - Fabian Alejandro Oliva López:** 1.1 Startup Profile, 1.1.1 Descripción de la Startup, 1.2.3 Lean UX Process (Supervisión general), 1.2.3.1 Lean UX Problem Statement, 1.3 Segmentos objetivo. **Persona 2 - Javier Masaru Nikaido Vargas:** 1.1.2 Perfiles de integrantes del equipo (Recopilación), 2.1 Competidores (Benchmarking), 2.2 Entrevistas (Planificación y ejecución), 2.3 Needfinding. **Persona 3 - Matias Rodolfo Salcedo Champi:** 1.2 Solution Profile, 1.2.1 Nombre del producto, 1.2.2 Antecedentes y problemática, 2.3.1 User Personas, 2.3.3 Empathy Maps. **Persona 4 - Percy Alonso Muñiz Huayanca:** 1.2.3.2 Lean UX Assumptions, 1.2.3.3 Lean UX Hypothesis, 2.3.2 User Task Matrix, 2.3.4 As-is Scenario Mapping, 3.1 To-Be Scenario Mapping. **Persona 5 - Pietro Osores Marchese:** 1.2.3.4 Lean UX Canvas, 3.2 User Stories, 3.3 Impact Map, 3.4 Product Backlog (Avance 1). | El equipo ha demostrado capacidad para integrar y aplicar conocimientos de arquitectura de software en un proyecto real de solución tecnológica. Cada integrante actualizó sus conocimientos en las áreas de UX, diseño de producto, análisis de procesos y gestión de requerimientos, aplicando metodologías ágiles y herramientas de elicitación de requisitos. |
| **CO2:** Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software. | **Persona 1 - Fabian Alejandro Oliva López:** 1.1 Startup Profile, 1.1.1 Descripción de la Startup, 1.2.3 Lean UX Process (Supervisión general), 1.2.3.1 Lean UX Problem Statement, 1.3 Segmentos objetivo. **Persona 2 - Javier Masaru Nikaido Vargas:** 1.1.2 Perfiles de integrantes del equipo (Recopilación), 2.1 Competidores (Benchmarking), 2.2 Entrevistas (Planificación y ejecución), 2.3 Needfinding. **Persona 3 - Matias Rodolfo Salcedo Champi:** 1.2 Solution Profile, 1.2.1 Nombre del producto, 1.2.2 Antecedentes y problemática, 2.3.1 User Personas, 2.3.3 Empathy Maps. **Persona 4 - Percy Alonso Muñiz Huayanca:** 1.2.3.2 Lean UX Assumptions, 1.2.3.3 Lean UX Hypothesis, 2.3.2 User Task Matrix, 2.3.4 As-is Scenario Mapping, 3.1 To-Be Scenario Mapping. **Persona 5 - Pietro Osores Marchese:** 1.2.3.4 Lean UX Canvas, 3.2 User Stories, 3.3 Impact Map, 3.4 Product Backlog (Avance 1). | El equipo reconoce que el desarrollo de soluciones de software requiere aprendizaje continuo. La aplicación de metodologías como Lean UX, Needfinding, User Stories e Impact Mapping evidencia el compromiso de cada miembro por adquirir nuevas competencias y adaptarse a las tendencias tecnológicas del mercado de movilidad urbana. |
