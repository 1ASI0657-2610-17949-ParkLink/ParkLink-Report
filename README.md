...
|---|---|---|
| **CO1:** Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y, en especial, para su proyecto en soluciones de software. | - **TB1 – Fabian Alejandro Oliva López:** Definió el ADN de la startup, estableciendo visión, misión, valores y segmentos objetivo.<br><br>- **TB1 – Javier Masaru Nikaido Vargas:** Realizó benchmarking, entrevistas y needfinding para validar el problema con usuarios reales.<br><br>- **TB1 – Matias Rodolfo Salcedo Champi:** Diseñó el Solution Profile, nombre del producto, User Personas y Empathy Maps.<br><br>- **TB1 – Percy Alonso Muñiz Huayanca:** Desarrolló Lean UX Assumptions, Hypothesis Statements, User Task Matrix, As-is y To-Be Scenario Mapping.<br><br>- **TB1 – Pietro Osores Marchese:** Elaboró el Lean UX Canvas, User Stories, Impact Map y Product Backlog.<br><br>- **TB2 – Fabian Alejandro Oliva López:** Elaboró los Principle Statements, participó en la definición de Architectural Drivers y revisó el Kanban Board de las iteraciones ADD.<br><br>- **TB2 – Javier Masaru Nikaido Vargas:** Documentó el Design Purpose, Primary User Stories, Constraints y la trazabilidad entre historias de usuario y decisiones de diseño.<br><br>- **TB2 – Matias Rodolfo Salcedo Champi:** Desarrolló el System Landscape Diagram, Context Level Diagrams y vistas C4 relacionadas con disponibilidad y reservas.<br><br>- **TB2 – Pietro Osores Marchese:** Elaboró el diagrama de base de datos relacional/no relacional, definiendo tablas como USERS, PARKING_SPACES, RESERVATIONS y PAYMENTS.<br><br>- **TB2 – Percy Alonso Muñiz Huayanca:** Desarrolló la Iteration 3 de ADD, documentó ADRs sobre pagos, webhooks, auditoría y notificaciones.<br><br>- **AV3 – Fabian Alejandro Oliva López:** Apoyó en la integración inicial del repositorio `ParkLink-Frontend`, diferenciando la landing informativa de la aplicación funcional.<br><br>- **AV3 – Javier Masaru Nikaido Vargas:** Trabajó en la mejora del API Gateway, rutas protegidas y documentación Swagger.<br><br>- **AV3 – Pietro Osores Marchese:** Desarrolló funcionalidades del backend relacionadas con autenticación, JWT, reservas, Prisma y conexión con PostgreSQL.<br><br>- **AV3 – Percy Alonso Muñiz Huayanca:** Participó en la gestión de espacios de estacionamiento, seguimiento del tablero Kanban y validación básica de endpoints.<br><br>- **AV3 – Matias Rodolfo Salcedo Champi:** Apoyó en la consulta de espacios disponibles, estructura base de notificaciones y revisión cruzada entre Front-End, API Gateway y backend.<br><br>- **AV4 – Fabian Alejandro Oliva López:** Consolidó la documentación final, validó la integración end-to-end de la app Flutter con el backend y generó el reporte final en PDF.<br><br>- **AV4 – Javier Masaru Nikaido Vargas:** Gestionó el despliegue del backend y API Gateway en Vercel, configuró PostgreSQL en Render y verificó los endpoints en producción.<br><br>- **AV4 – Pietro Osores Marchese:** Completó el backend transaccional, implementó el seed de datos reales de Lima y configuró el deploy serverless en Vercel.<br><br>- **AV4 – Percy Alonso Muñiz Huayanca:** Actualizó `DEPLOY-GUIDE.md`, elaboró `RENDER-SEED-DATA.md` y aseguró la trazabilidad de evidencias.<br><br>- **AV4 – Matias Rodolfo Salcedo Champi:** Completó la app Flutter nativa con Google Maps, autenticación, detalle de cocheras, reservas y pagos.<br><br>- **TF – Fabian Alejandro Oliva López:** Consolidó criterios de experiencia de usuario, evidencias visuales web/mobile y el reporte final del Sprint 3.<br><br>- **TF – Javier Masaru Nikaido Vargas:** Gestionó el despliegue completo del backend y API Gateway, la base de datos PostgreSQL en Render y la validación de endpoints.<br><br>- **TF – Pietro Osores Marchese:** Completó el backend transaccional, las technical stories, el seed de datos reales y el deploy serverless.<br><br>- **TF – Percy Alonso Muñiz Huayanca:** Documentó el despliegue multi-plataforma y aseguró la trazabilidad técnica de las evidencias.<br><br>- **TF – Matias Rodolfo Salcedo Champi:** Completó la app Flutter con Google Maps, JWT, reservas, pagos y conexión con el backend en producción. | El equipo demostró capacidad para actualizar, integrar y aplicar conocimientos técnicos y metodológicos en una solución real de software. A través de Lean UX, User Stories, Impact Mapping, DDD, C4 Model, ADD, ADRs, NestJS, Prisma, PostgreSQL, Flutter, Google Maps, API Gateway, Vercel y Render, se consolidó una arquitectura funcional conectada con las necesidades del producto ParkLink y validada en un entorno cercano a producción. |
| **CO2:** Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software. | - **TB1 – Fabian Alejandro Oliva López:** Reconoció la importancia de actualizar conocimientos en estrategia de producto y liderazgo de proyectos.<br><br>- **TB1 – Javier Masaru Nikaido Vargas:** Identificó la necesidad de mejorar continuamente técnicas de investigación de usuarios y comunicación con stakeholders.<br><br>- **TB1 – Matias Rodolfo Salcedo Champi:** Comprendió la relevancia del aprendizaje continuo en diseño centrado en el usuario.<br><br>- **TB1 – Percy Alonso Muñiz Huayanca:** Reconoció la necesidad de actualizarse en herramientas de análisis y modelado de procesos de negocio.<br><br>- **TB1 – Pietro Osores Marchese:** Entendió la importancia del aprendizaje continuo en gestión de requerimientos y priorización ágil.<br><br>- **TB2 – Fabian Alejandro Oliva López:** Fortaleció criterios de diseño arquitectónico, trade-offs y priorización de drivers.<br><br>- **TB2 – Javier Masaru Nikaido Vargas:** Reforzó aprendizajes sobre trazabilidad entre requisitos, restricciones, atributos de calidad y decisiones arquitectónicas.<br><br>- **TB2 – Matias Rodolfo Salcedo Champi:** Profundizó en C4 Model y Structurizr para comunicar arquitectura mediante vistas visuales claras.<br><br>- **TB2 – Pietro Osores Marchese:** Actualizó conocimientos sobre consistencia transaccional, modelado relacional, restricciones ACID y separación entre cache y base de datos.<br><br>- **TB2 – Percy Alonso Muñiz Huayanca:** Aprendió a aplicar ADD, documentar ADRs y manejar integraciones externas mediante adaptadores, idempotencia y resiliencia.<br><br>- **AV3 – Fabian Alejandro Oliva López:** Aprendió la importancia de separar una landing de presentación de un Front-End funcional conectado a servicios reales.<br><br>- **AV3 – Javier Masaru Nikaido Vargas:** Reforzó conocimientos sobre API Gateway, Swagger y control de rutas protegidas.<br><br>- **AV3 – Pietro Osores Marchese:** Fortaleció conocimientos sobre backend NestJS, autenticación JWT, Prisma y despliegue serverless.<br><br>- **AV3 – Percy Alonso Muñiz Huayanca:** Aprendió a organizar el seguimiento de tareas técnicas mediante Kanban y validación de endpoints.<br><br>- **AV3 – Matias Rodolfo Salcedo Champi:** Reforzó conocimientos sobre integración entre Front-End, API Gateway, backend y módulos base de notificación.<br><br>- **AV4 – Fabian Alejandro Oliva López:** Aprendió a generar reportes académicos con evidencias técnicas reales y consolidar documentación multi-repositorio.<br><br>- **AV4 – Javier Masaru Nikaido Vargas:** Fortaleció habilidades DevOps en Render, Vercel, variables de entorno, seed de datos y troubleshooting de deploy serverless.<br><br>- **AV4 – Pietro Osores Marchese:** Aprendió a desplegar NestJS con Prisma en Vercel, manejar PostgreSQL externo en Render y ejecutar seed scripts en producción.<br><br>- **AV4 – Percy Alonso Muñiz Huayanca:** Desarrolló habilidades de documentación técnica de infraestructura multi-plataforma usando Render, Vercel y GitHub.<br><br>- **AV4 – Matias Rodolfo Salcedo Champi:** Aprendió a consumir APIs REST desde Flutter, integrar Google Maps, manejar tokens JWT con `flutter_secure_storage` y probar la app móvil conectada al backend.<br><br>- **TF – Equipo ParkTeam:** Consolidó aprendizajes críticos sobre despliegue serverless, conexión SSL a PostgreSQL externo, seed de datos geo-referenciados, integración Google Maps en Flutter, manejo seguro de JWT, documentación técnica y generación automatizada de reportes. | El equipo reconoce que el desarrollo de soluciones de software exige aprendizaje permanente, investigación técnica, revisión de documentación oficial, pruebas en entornos reales y adaptación frente a restricciones de infraestructura, APIs externas y flujos de integración multiplataforma. El aprendizaje continuo fue clave para superar los retos técnicos del proyecto y entregar una solución funcional en producción. |
## Contenido 
...
El despliegue actual distribuye la solución en servicios cloud administrados: backend y API Gateway en **Vercel**, persistencia en **Render PostgreSQL**, frontend web en **Vercel** y app móvil Flutter ejecutada en Android. Esta distribución permite separar responsabilidades, mantener HTTPS extremo a extremo y validar el comportamiento del sistema en un entorno cercano a producción.
...
La arquitectura cloud de ParkLink organiza los clientes, gateway, servicios backend, base de datos administrada e integraciones externas bajo una topología de despliegue desacoplada. El frontend web y la app Flutter consumen el API Gateway como punto de entrada, mientras que el backend conserva las reglas de negocio y accede a la base PostgreSQL administrada.

![ParkLink Cloud Architecture Diagram](assets/deployment-diagram.svg)

**Componentes principales del despliegue cloud:**

| Capa | Componente | Plataforma | Responsabilidad |
|------|------------|------------|-----------------|
| Cliente móvil | ParkLink Flutter App | Android / Flutter | Permite login, búsqueda en mapa, detalle de cocheras, reservas y pago simulado. |
| Cliente web | ParkLink Frontend | Vercel | Expone la experiencia web funcional para conductores y propietarios. |
| Entrada del sistema | API Gateway | Vercel Serverless | Centraliza rutas, conserva headers de autorización y evita exponer servicios internos directamente. |
| Servicios backend | ParkLink Backend | Vercel Serverless | Ejecuta reglas de negocio de autenticación, usuarios, espacios, reservas, pagos, auditoría y notificaciones. |
| Persistencia | PostgreSQL | Render | Mantiene datos transaccionales, usuarios, espacios, reservas, pagos y auditoría. |
| Integraciones externas | Google Maps / servicios futuros | APIs externas | Soporta geolocalización, mapas y futuras integraciones de pagos o notificaciones. |

**Representación lógica del flujo entre componentes:**

```mermaid
flowchart TD
    A[Frontend Web / App Flutter] --> B[API Gateway<br/>Vercel Serverless]
    B --> C[Backend ParkLink<br/>NestJS + Prisma]
    ...
    A --> L[Google Maps SDK / API]
    J --> L
```

### 5.3.2 Cloud Architecture Deployment

El despliegue cloud final fue validado con evidencia real de las plataformas usadas por ParkLink. La infraestructura queda dividida en tres piezas principales: backend API, API Gateway y base de datos PostgreSQL administrada. Esta separación permite actualizar cada componente de forma independiente y mantener trazabilidad de despliegues por plataforma.

**Resumen del despliegue final:**

| Componente | Plataforma | URL / recurso | Estado |
|------------|------------|---------------|--------|
| Backend API | Vercel | `https://parklink-platform.vercel.app` | Desplegado y validado con health check, Swagger y endpoints funcionales. |
| API Gateway | Vercel | `https://api-gateway-xi-five.vercel.app` | Desplegado y validado como punto de entrada hacia servicios backend. |
...
El despliegue final demuestra que ParkLink cuenta con una arquitectura cloud funcional y separada por responsabilidades. Vercel permite operar backend y API Gateway con HTTPS administrado y despliegues reproducibles; Render proporciona persistencia PostgreSQL administrada; y GitHub conserva la trazabilidad de cambios, ramas y evidencias. La solución queda preparada para evolucionar hacia microservicios independientes sin romper la estructura modular ya documentada.

---

## 5.4 Sprint Reviews

La siguiente sección consolida los Sprint Reviews del proyecto, incluyendo backlog, evidencias de desarrollo, pruebas, ejecución, documentación de microservicios, despliegue, colaboración y tablero Kanban por sprint.
...
#### 5.4.1.2 Development Evidence for Sprint Review
...
#### 5.4.1.3 Testing Suite Evidence for Sprint Review
...
#### 5.4.1.4 Execution Evidence for Sprint Review
...
#### 5.4.1.5 Microservices Documentation Evidence for Sprint Review
...
#### 5.4.1.6 Software Deployment Evidence for Sprint Review
...
#### 5.4.1.7 Team Collaboration Insights during Sprint
...
| Javier Masaru Nikaido Vargas | Documentación técnica del informe (5.4.1.2, 5.4.1.3, 5.4.1.5), facilitación de Sprint Planning | Sin SBI técnicos asignados | 0 |
| Fabian Alejandro Oliva Lopez | Documentación de infra y ejecución (5.4.1.1, 5.4.1.4, 5.4.1.6), facilitación de Sprint Review | Sin SBI técnicos asignados | 0 |
| Percy Alonso Muñiz Huayanca | Tablero Trello, documentación de proceso (5.4.1.7, 5.4.1.8), cierre del informe, facilitación de Sprint Retrospective | Sin SBI técnicos asignados | 0 |
...
---
  ...
  #### 5.4.2.2 Development Evidence for Sprint Review
  ...
  **Repositorio — `ParkLink-Frontend` (web frontend funcional):**
  ...
  #### 5.4.2.3 Testing Suite Evidence for Sprint Review
  ...
  **Deuda técnica de testing registrada para próximos sprints:**
  ...
  #### 5.4.2.4 Execution Evidence for Sprint Review
  ...
  **Despliegue:** Vercel, rama `master` del repositorio `ParkLink-Frontend`, build automático por push, TLS gestionado por Vercel (100% HTTPS).
  ...
  #### 5.4.2.5 Microservices Documentation Evidence for Sprint Review
...
#### 5.4.2.6 Software Deployment Evidence for Sprint Review
...
#### 5.4.2.7 Team Collaboration Insights during Sprint
...
#### 5.4.3.5 Microservices Documentation Evidence for Sprint Review

Para el Sprint Review del Trabajo Final se validó que la documentación OpenAPI estuviera publicada en producción y que permitiera evidenciar los contratos principales del backend y del API Gateway. La documentación Swagger se encuentra disponible en `/docs`, mientras que la especificación cruda OpenAPI se mantiene en `/docs-json`.
...
| Backend | `GET /docs-json` | Especificación OpenAPI 3.0 del backend |
| Backend | `GET /parking-spaces/search?lat=-12.0464&lng=-77.0428&maxDistance=8` | Prueba real de búsqueda de espacios cercanos en Lima |
...
| API Gateway | `GET /health` | Validación de disponibilidad del gateway y backend downstream |
| API Gateway | `GET /routes` | Evidencia de rutas proxy configuradas hacia el backend consolidado |
...
| Componente | URL de Swagger | Estado validado |
|------------|----------------|-----------------|
| Backend API | `https://parklink-platform.vercel.app/docs` | Carga Swagger UI, expone contratos por bounded context y enlaza `/docs-json` |
| API Gateway | `https://api-gateway-xi-five.vercel.app/docs` | Carga Swagger UI, muestra rutas proxy y health check del gateway |

**Evidencia visual de Swagger y pruebas de endpoints:**

| Evidencia | Captura |
|----------|---------|
| Swagger UI del Backend en producción | ![Backend Swagger Docs](screenshots/microservices/backend-swagger-docs.png) |
| Prueba `GET /health` del Backend | ![Backend Health Endpoint](screenshots/microservices/backend-health-endpoint.png) |
| Prueba `GET /parking-spaces/search` del Backend con coordenadas de Lima | ![Backend Parking Search Endpoint](screenshots/microservices/backend-parking-search-endpoint.png) |
| Swagger UI del API Gateway en producción | ![Gateway Swagger Docs](screenshots/microservices/gateway-swagger-docs.png) |
| Prueba `GET /health` del API Gateway | ![Gateway Health Endpoint](screenshots/microservices/gateway-health-endpoint.png) |
| Prueba `GET /routes` del API Gateway | ![Gateway Routes Endpoint](screenshots/microservices/gateway-routes-endpoint.png) |

Estas evidencias demuestran que la documentación técnica de los microservicios quedó disponible para revisión, que los contratos OpenAPI están publicados en producción y que los endpoints principales responden correctamente desde las URLs finales usadas por el frontend web y la app móvil.

#### 5.4.3.6 Software Deployment Evidence for Sprint Review
...
#### 5.4.3.7 Team Collaboration Insights during Sprint
